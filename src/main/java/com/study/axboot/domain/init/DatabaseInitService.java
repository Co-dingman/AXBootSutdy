package com.study.axboot.domain.init;

import com.study.axboot.domain.code.CommonCode;
import com.study.axboot.domain.code.CommonCodeService;
import com.study.axboot.domain.program.Program;
import com.study.axboot.domain.program.ProgramService;
import com.study.axboot.domain.program.menu.Menu;
import com.study.axboot.domain.program.menu.MenuService;
import com.study.axboot.domain.user.User;
import com.study.axboot.domain.user.UserService;
import com.study.axboot.domain.user.auth.UserAuth;
import com.study.axboot.domain.user.auth.UserAuthService;
import com.study.axboot.domain.user.auth.menu.AuthGroupMenu;
import com.study.axboot.domain.user.auth.menu.AuthGroupMenuService;
import com.study.axboot.domain.user.role.UserRole;
import com.study.axboot.domain.user.role.UserRoleService;
