package com.study.axboot.domain;

import com.study.axboot.domain.code.QCommonCode;
import com.study.axboot.domain.file.QCommonFile;
import com.study.axboot.domain.program.QProgram;
import com.study.axboot.domain.program.menu.QMenu;
import com.study.axboot.domain.user.QUser;
import com.study.axboot.domain.user.auth.QUserAuth;
import com.study.axboot.domain.user.auth.menu.QAuthGroupMenu;
import com.study.axboot.domain.user.role.QUserRole;
